...
from src.main.experiments.abstract.predict_onehot_ccs_2 import predict_onehot_ccs_2
...
def main() -> None:
    ...
    for _ in range(1):
        predict_onehot_ccs_2(code, input_props=["charge", "mass", "length"], output_props=["ccs"], proteins=proteins)
