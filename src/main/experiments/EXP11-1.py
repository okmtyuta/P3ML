...
from src.main.experiments.abstract.predict_onehot_ccs_3 import predict_onehot_ccs_3
from src.modules.helper.helper import Helper
from src.modules.protein.protein_list import ProteinList
from src.modules.slack_service import SlackService

code = Path(__file__).stem
proteins = ProteinList.from_hdf5(Helper.ROOT / "source" / "ishihama" / "pwesm2.h5").proteins
...
def main() -> None:
    ...
    for _ in range(1):
        predict_onehot_ccs_3(code, input_props=["charge", "mass", "length"], output_props=["ccs"], proteins=proteins)
