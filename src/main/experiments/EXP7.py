...
proteins = ProteinList.from_hdf5(Helper.ROOT / "source" / "schwanhausser" / "esm2" / "logarithm.h5").proteins
...
def main() -> None:
    ...
    result = transfer_predict_hl_1(
        code=code, from_code="EXP3", from_version="version_8", input_props=[], output_props=["log_halflife"], proteins=proteins
    )
